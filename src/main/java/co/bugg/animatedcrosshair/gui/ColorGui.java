...
public class ColorGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiSlider(responder, buttonId, width / 2 - sliderWidth / 2, height / 2 - sliderHeight / 2 + (sliderHeight + sliderMargin) * (buttonId - 2), new ChatComponentTranslation("animatedcrosshair.color.red").getUnformattedText(), 0F, 255F, red, formatHelper));
        buttonId++;
        buttonList.add(new GuiSlider(responder, buttonId, width / 2 - sliderWidth / 2, height / 2 - sliderHeight / 2 + (sliderHeight + sliderMargin) * (buttonId - 2), new ChatComponentTranslation("animatedcrosshair.color.green").getUnformattedText(), 0F, 255F, green, formatHelper));
        buttonId++;
        buttonList.add(new GuiSlider(responder, buttonId, width / 2 - sliderWidth / 2, height / 2 - sliderHeight / 2 + (sliderHeight + sliderMargin) * (buttonId - 2), new ChatComponentTranslation("animatedcrosshair.color.blue").getUnformattedText(), 0F, 255F, blue, formatHelper));
        buttonId++;
        // TODO
...
//        buttonId++;
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if(button.displayString.equalsIgnoreCase(new ChatComponentTranslation("animatedcrosshair.config.save").getUnformattedText())) {
            ...
            chroma = !chroma;
            button.displayString = new ChatComponentTranslation("animatedcrosshair.color.chroma").getUnformattedText() + ": " + (chroma ? new ChatComponentTranslation("animatedcrosshair.config.enabled").getUnformattedText() : new ChatComponentTranslation("animatedcrosshair.config.disabled").getUnformattedText());
    ...
    public class ColorGuiFormatHelper implements GuiSlider.FormatHelper {
        final String red = new ChatComponentTranslation("animatedcrosshair.color.red").getUnformattedText();
        final String green = new ChatComponentTranslation("animatedcrosshair.color.green").getUnformattedText();
        final String blue = new ChatComponentTranslation("animatedcrosshair.color.blue").getUnformattedText();
